...
Function Get-FileMetaData
{
 ...
 #Retrieve metadata of files in a directory, recursively
 $fileMeta2 = Get-FileMetaData -folder (gci C:\Users\Amadeus\Desktop\Music\F50 -Recurse -Directory).FullName
 
 #Select only specific metadata tags and export to CSV
 $fileMeta2 | select Title, Authors, Album, Path, `#, File Extension  | Export-Csv -Path C:\Users\Amadeus\Desktop\apple3.csv -Encoding ascii -NoTypeInformation